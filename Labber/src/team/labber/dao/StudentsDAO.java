 ...
 * 
 * @see team.labber.entities.Students
...
public class StudentsDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String _SCLASS_ID = "SClassId";
	...
	public Students findById(java.lang.String id) {
		...
		try {
			Students instance = (Students) getSession().get(
					"team.labber.entities.Students", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Students instance) {
		...
		try {
			List results = getSession()
					.createCriteria("team.labber.entities.Students")
	...
	public List findBySClassId(Object SClassId) {
		return findByProperty(_SCLASS_ID, SClassId);
	}
