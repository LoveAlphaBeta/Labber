 ...
 * 
 * @see team.labber.entities.Classes
...
public class ClassesDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String _CSTUDENT_NUMBERS = "CStudentNumbers";
	...
	public Classes findById(java.lang.String id) {
		...
		try {
			Classes instance = (Classes) getSession().get(
					"team.labber.entities.Classes", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Classes instance) {
		...
		try {
			List results = getSession()
					.createCriteria("team.labber.entities.Classes")
	...
	public List findByCStudentNumbers(Object CStudentNumbers) {
		return findByProperty(_CSTUDENT_NUMBERS, CStudentNumbers);
	}
